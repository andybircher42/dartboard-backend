...
class RetryExecutorTest {
	...
	void succeedsAfterRetry() {
		...
		RetryResult<String> result = executor.execute(policy, () -> {
	...
	void interruptedDuringSleep_returnsFailure() {
		RetryExecutor interruptingExecutor = new RetryExecutor(ms -> {
		...
		RetryResult<String> result = interruptingExecutor.execute(policy, () -> {
	...
	void resultGetOrThrow_afterExecuteFailure() {
		...
		RetryResult<Integer> result = executor.execute(policy,
